...
export async function updateUserProfile(data: UpdateProfileData): Promise<{ message: string; user: UserProfile }> {
  const res = await axios.put<{ message: string; user: UserProfile }>('/api/users/me', data);
  return res.data;
}
...
export async function fetchMyHostel(): Promise<HostelInfo | null> {
  try {
    const res = await axios.get<HostelInfo[]>('/api/hostels');
...
export async function fetchCheckIns(): Promise<CheckIn[]> {
  try {
    const res = await axios.get<CheckIn[]>('/api/check-ins');
    return res.data;
  } catch (error: any) {
...
export async function checkInStudent(payload: {
  ...
  const res = await axios.post<{ checkInId: number; message: string }>('/api/check-ins', payload);
  return res.data;
}
...
export async function checkOutStudentFromCheckIn(payload: {
  ...
  await axios.post('/api/check-ins/checkout', payload);
}
...
export async function createExpense(payload: {
  ...
  const res = await axios.post<{ expenseId: number; message: string }>('/api/expenses', payload);
  return res.data;
}
...
export async function fetchExpenses(params?: {
  ...
  const res = await axios.get<ExpenseListResponse>('/api/expenses', { params });
  return res.data;
}
...
export async function fetchExpenseStats(params?: {
  ...
  const res = await axios.get<ExpenseStats>('/api/expenses/stats', { params });
  return res.data;
}
...
export async function fetchStudentSMSHistory(studentId: number): Promise<SMSHistory[]> {
  const res = await axios.get<SMSHistory[]>(`/api/students/${studentId}/sms-history`);
  return res.data;
}